...
public class DetailPelayan1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_pelayan1);
                ...
                mApiService.notifRequest1(prefManager.getNamaUser(),prefManager.getBankingUsername(prefManager.getIndexBanking()),prefManager.getTypeLoket(prefManager.getIndexTypeLoket())).enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        try {
                            ...
                            if(pushnomor != null ) {
                                NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(DetailPelayan1.this, Utils.FIRST_CHANNEL_ID)
                                        .setSmallIcon(R.drawable.logo_bri)
                                ...
                                notificationManager.notify(Utils.FIRST_NOTIFICATION_ID, mBuilder.build());
                            }
