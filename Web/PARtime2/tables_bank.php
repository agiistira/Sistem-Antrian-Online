...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
    <ul>
      ...
      <li class="active"><a href="tables_bank.php"><i class="icon icon-th"></i> <span>Personal Pelayanan</span></a></li>
      <li><a href="pengantri_bank.php"><i class="icon icon-th"></i> <span>Personal Pengantri</span></a></li>
