...
<div id="header">
  <h3 class="span12"><a>Admin <?php echo  $_SESSION["titel"] ;  ?></a></h3>
</div>
<!--sidebar-menu-->
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
    <ul>
      <li><a href="index_master_bank.php"><i class="icon icon-home"></i> <span>Home</span></a> </li>
      <li ><a href="tables_bank.php"><i class="icon icon-th"></i> <span>Personal Pelayanan</span></a></li>
      <li class="active"><a href="pengantri_bank.php"><i class="icon icon-th"></i> <span>Personal Pengantri</span></a></li>
